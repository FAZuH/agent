# Logging Guidelines at @skills/logging-guidelines/ Skill

A skill for AI coding assistants to apply logging guidelines at @skills/logging-guidelines/ when writing or reviewing code.
